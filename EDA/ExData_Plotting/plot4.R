...
# Set Parameters for 2 columns and 2 rows for graphics device png.
par(mfrow = c(2,2))
## Create plots in current graphic device, label axis and main title
plot(power.data$Time, power.data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power", main = "")
