...
After cleaning the data we end up with a data set that can be used to train the model. In the next section we will train the model and apply K-Fold Cross Validation using the train_control function.
